...
迟到的更新![KuXiao](https://img1.imgtp.com/2023/06/15/xy3aOIBa.png)

主要修复了一些比较突出的问题，同时也感谢这段时间内在社区提供解决方案的大牛们![GoodJob](https://i.loli.net/2020/05/27/s2rPUJteBYOE1I7.png)

至于反馈提出的一些功能性需求，我觉得合适的会整合进脚本，功能不是越多越好，配置项变多，只会越来越臃肿，所以计划添加一个插件功能，将一些小众功能及定制化的功能使用插件来实现，如需要可以自行单独安装，当然也可以根据插件开发文档自行开发，当然思路还在拟定当中，以最终效果为准。
...
- 添加Excel新皮肤[**腾讯文档**]，此皮肤为矢量图绘制，具有**缩放不失真**的优点，1080P+高分屏推荐使用

    ![Excel皮肤-腾讯文档预览](https://img1.imgtp.com/2023/06/20/RLzmruAY.png)

- 增强扩展坞功能，新添加**查看个人界面**、**收藏**、**回复**功能
...
> 很多人反馈要添加广告屏蔽功能，作者是没有精力去维护广告屏蔽策略的，关于这个我还是建议直接使用广告屏蔽插件，专业的事专业人来干，市面上可供选择的插件有很多，例如AdGuard、ADBlock等。
