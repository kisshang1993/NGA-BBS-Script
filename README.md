...
- 新增高级设置：**隐藏版头同时隐藏背景图片**，默认为**不隐藏**
- ![Snipaste_2020-09-10_18-07-08.jpg](https://i.loli.net/2020/09/10/ocrabdsnpWKMRIH.jpg)、
- 新增高级设置：**按需显示标注拉黑按钮**，默认为**不隐藏**
- ![auto maker demo](https://pic.downk.cc/item/5f9a79661cd1bbb86bcc5c04.gif) (此预览效果由[@biuuu](https://github.com/kisshang1993/NGA-BBS-Script/pull/13)提供)
- **新增扩展坞**，在页面的右下角固定位置，鼠标停留
- 返回顶部（默认快捷键 `T`）
- 跳转至最后一页（默认快捷键 `B`）
- ![docker demo](https://pic.downk.cc/item/5f9a92f81cd1bbb86bd50f93.gif)
- 以上按键均可以在*编辑快捷键*中自定义
