...
目前脚本功能较多，略微臃肿，所以后续一些实验性或定制型的功能更新会以插件的形式来发布，若插件群众普遍反响不错，再考虑整合进主体脚本中

插件功能另一方面是因为作者思维跟精力有限，并不能满足每一个人的需求，可以让各位有技术能力的大佬也可以根据自己的实际需求来满足定制化的功能，亦或者编写插件发布在脚本托管平台来扩展能力，丰富生态

---

随着本次更新作者也发布了一款插件，从下方“获取插件”连接来安装即可

- **帖子浏览记录** (记录帖子的阅读状态，着色以阅读帖子标题，跟踪后续新回复数量)
